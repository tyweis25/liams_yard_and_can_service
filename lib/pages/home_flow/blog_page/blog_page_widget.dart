          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: Builder(
                  builder: (context) {
                    final blogAllList = FFAppState().blogList.toList();

                    return ListView.separated(
                      padding: EdgeInsets.symmetric(vertical: 16.0),
                      scrollDirection: Axis.vertical,
                      itemCount: blogAllList.length,
                      separatorBuilder: (_, __) => SizedBox(height: 16.0),
                      itemBuilder: (context, blogAllListIndex) {
                        final blogAllListItem = blogAllList[blogAllListIndex];
                        return InkWell(
                          ...
                          onTap: () async {
                            context.pushNamed(
                              BlogDetailPageWidget.routeName,
                              queryParameters: {
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: CachedNetworkImage(
                                      ...
                                      fadeOutDuration:
                                          Duration(milliseconds: 500),
                                      imageUrl: blogAllListItem.image,
                                      width: 119.0,
                                      height: 119.0,
                                      fit: BoxFit.cover,
                                      errorWidget:
